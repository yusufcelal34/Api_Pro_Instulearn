Feature: As an administrator, I want to update the information of the course category with the specified ID via an API connection.
  ...
  response matches the {id} path parameter.
    ...
    * Rekare The api user prepares a PATCH request containing the "<title>" information to send to the api updateCategory endpoint.
    ...
    * The api user verifies that the "Updated Blog Id" information in the response body is the same as the id path parameter in the endpoint.
