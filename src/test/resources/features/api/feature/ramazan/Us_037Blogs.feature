...
Examples:
  ...
  # Api kullanicisi response body'deki belirtilen alanlari dogrular
    ...
    the remark in the response body is "failed", and the message is "No id".
      ...
      * Rekare The api user verifies that the status code is 203.

      * Rekare The api user verifies that the "remark" information in the response body is "failed".

      * Rekare The api user verifies that the "data.message" information in the response body is "There is not blog for this id.".
...
and the message information is "No id".
  ...
  * Rekare The api user sets "api/blog" path parameters.
  ...
  * Rekare The api user verifies that the "data.message" information in the response body is "No id".
