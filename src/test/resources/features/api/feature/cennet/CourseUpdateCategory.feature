Feature: As an administrator, I want to update the information of the course category with the specified ID via an API connection.
  ...
  response matches the {id} path parameter.
    ...
    * C The api user sets "api/updateCategory/886" path parameters.
    # Api kullanicisi "api/updateCategory/id" path parametrelerini olusturur
    * C The api user prepares a PATCH request containing the "<title>" information to send to the api updateCategory endpoint.
    # Api kullanicisi api updateCategory endpointine gondermek icin bir patch request body hazirlar
    * C The api user sends a "PATCH" request and saves the returned response.
    ...
    * C The api user verifies that the "Message" information in the response body is "Successfully Updated.".
    # Api kullanicisi response bodydeki Message bilgisinin "Successfully Updated." oldugunu dogrular
    #* C The api user verifies that the "Updated Category Id" information in the response body is the same as the id path parameter in the endpoint.
  ...
  the remark information in the response body is "failed" and the message information is "There is not category for this id."
    ...
    * C  The api user constructs the base url with the "admin" token.
    # Api kullanicisi "admin" token ile base urli olusturur
    * C The api user sets "api/updateCategory/12547" path parameters.
    # Api kullanicisi "api/updateCategory/id" path parametrelerini olusturur
    * C The api user prepares a POST request to send to the API addCategory endpoint.
    # Api kullanicisi api updateCategory endpointine gondermek icin bir patch request body hazirlar
    * C The api user sends a "PATCH" request and saves the returned response.
    # Api kullanicisi PATCH request gonderir ve donen responsei kaydeder
  ...
  remark information in the response body is "failed" and the message information is "No id".
    ...
    * C  The api user constructs the base url with the "admin" token.
    # Api kullanicisi "admin" token ile base urli olusturur
    * C The api user sets "api/updateCategory" path parameters.
    # Api kullanicisi "api/updateCategory/id" path parametrelerini olusturur
    * C The api user prepares a patch request body to send to the api updateCategory endpoint.
    # Api kullanicisi api updateCategory endpointine gondermek icin bir patch request body hazirlar
    * C The api user sends a PATCH request and saves the returned response.
    # Api kullanicisi PATCH request gonderir ve donen responsei kaydeder
    * C The api user verifies that the status code is 203.
  ...
  returns status 401 and message “Unauthenticated.”
    ...
    * C The api user verifies that the "message" information in the response body is "Unauthenticated.".
  ...
  /api/category/{id} using the Updated Category ID from the response.
    ...
    * C  The api user constructs the base url with the "admin" token.
    # Api kullanicisi "admin" token ile base urli olusturur
    * C The api user sets "api/category/<id>" path parameters.
    ...
    * C The api user verifies that the "title" information is "Education and Training"
